...
class BlogServiceImpl(
    ...
    override suspend fun create(createBlogEntry: CreateBlogEntry): BlogEntry {
        ...
        return persistenceHandler
            .modifyAndSave(dao = blogEntryDao) {
    ...
    override suspend fun findEntryBy(blogEntryId: UUID): BlogEntry? = blogRepository.findBlogEntryById(blogEntryId)?.toBlogEntry()
    ...
    override suspend fun saveOrUpdate(blog: Blog): Blog =
        persistenceHandler
            .modifyAndSave(dao = blog.toBlogDao()) {
    ...
    override suspend fun update(updateBlogTitle: UpdateBlogTitle): Blog {
        val blog =
            requireNotNull(blogRepository.findBlogById(updateBlogTitle.blogId)) { "Cannot find blog to update" }
