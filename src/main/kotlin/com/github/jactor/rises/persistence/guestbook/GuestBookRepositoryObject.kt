...
object GuestBookRepositoryObject : GuestBookRepository {
    ...
    override fun findByUserId(userId: UUID): GuestBookDao? =
        GuestBooks
            .selectAll()
    ...
    override fun findGuestBookById(id: UUID): GuestBookDao? =
        GuestBooks
            .selectAll()
    ...
    override fun findGuestBookEntryById(id: UUID): GuestBookEntryDao? =
        GuestBookEntries
            .selectAll()
    ...
    override fun findGuestBookEtriesByGuestBookId(id: UUID): List<GuestBookEntryDao> =
        GuestBookEntries
            .selectAll()
    ...
    private fun update(guestBookDao: GuestBookDao): GuestBookDao =
        GuestBooks
            .update(
    ...
    private fun insert(guestBookDao: GuestBookDao): GuestBookDao =
        GuestBooks
            .insertAndGetId {
                it[createdBy] = guestBookDao.createdBy
                it[title] = guestBookDao.title
            ...
            .let { guestBookDao.copy(id = it) }

    override fun save(guestBookEntryDao: GuestBookEntryDao): GuestBookEntryDao =
        when (guestBookEntryDao.isPersisted) {
            true -> update(guestBookEntryDao)
            false -> insert(guestBookEntryDao)
        }

    private fun update(guestBookEntryDao: GuestBookEntryDao): GuestBookEntryDao =
        GuestBookEntries
            .update(
    ...
    private fun insert(guestBookEntryDao: GuestBookEntryDao): GuestBookEntryDao =
        GuestBookEntries
            .insertAndGetId {
                it[createdBy] = guestBookEntryDao.createdBy
                it[guestBookId] = requireNotNull(guestBookEntryDao.guestBookId) { "GuestBookId cannot be null!" }
            ...
            .let { guestBookEntryDao.copy(id = it) }
}
